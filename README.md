...
The goal is to reconstruct the correct position of the final vertex by applying geometric and projective relationships.

**Included files:**  
- `1.ipynb` - computational solution  
- `box.jpg` - reference image used in the task
